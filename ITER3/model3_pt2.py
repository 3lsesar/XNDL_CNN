...
from keras.layers import Conv2D, GlobalAveragePooling2D, Dense, Flatten, BatchNormalization, LayerNormalization, Dropout
...
def train_cnn():
    ...
    model.add(Conv2D(64, (3, 3), padding='same', activation='relu', input_shape=input_shape, kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(Conv2D(64, (3, 3), padding='same', activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2)))
    
    # Segunda capa convolucional y de max pooling
    model.add(Conv2D(128, (3, 3), padding='same', activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(Conv2D(128, (3, 3), padding='same', activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2)))
    
    # Tercera capa convolucional y de max pooling
    model.add(Conv2D(256, (3, 3), padding='same', activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(Conv2D(256, (3, 3), padding='same', activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2)))
    
    # Cuarta capa convolucional y de max pooling
    model.add(Conv2D(512, (3, 3), padding='same', activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(Conv2D(512, (3, 3), padding='same', activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2)))
    ...
    model.add(Dense(4096, activation='relu', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
    model.add(Dropout(0.3))
    model.add(Dense(29, activation='softmax', kernel_initializer=he_normal(), kernel_regularizer=l2(0.001)))
