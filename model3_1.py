...
def plot_training_curve(history, dropout_value):
    ...
    plt.savefig(f'training_curves_model2{dropout_value}.pdf')
...
def train_cnn(dropout_value):
    ...
    plot_training_curve(history, dropout_value)
