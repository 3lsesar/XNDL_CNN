...
from keras.layers import Conv2D, GlobalAveragePooling2D, Dense, Flatten, BatchNormalization, LayerNormalization, MaxPooling2D
...
def train_cnn():
    ...
    # Quinta capa convolucional + Max Pooling
